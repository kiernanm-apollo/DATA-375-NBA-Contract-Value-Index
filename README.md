...
### Outlier Detection (QQ Analysis)
![Q-Q Plot: Identifying Elite Value](qq_plot_vorp.png)

### Structural Segmenting via K-Clustering
![NBA Player Clusters: Salary vs VORP](nba_clusters.png)

### CVI vs. Minutes Played Evaluation
![NBA Contract Value Index vs Minutes Played](cvi_leaders.png)
